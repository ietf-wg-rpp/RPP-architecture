...
*  **'VC' Structure Adaptation:**  Adapting to existing Verifiable Credentials (<<W3C-VC>>, <<draft-ietf-oauth-sd-jwt-vc>>) data structures, especially for representing identity or authorisation information, allowing for integration with external identity systems.
...
* **JWT-SD:** JSON data with Selective Disclosure using JWTs <<draft-ietf-oauth-selective-disclosure-jwt>> for minimisation of exposed data. 
...
* [[[draft-ietf-oauth-selective-disclosure-jwt, IETF(I-D.draft-ietf-oauth-selective-disclosure-jwt-22)]]] Fett, D., Yasuda, K., and B. Campbell, "Selective Disclosure for JWTs (SD-JWT)", May 2025, <https://datatracker.ietf.org/doc/html/draft-ietf-oauth-selective-disclosure-jwt-22>.
...
* [[[draft-ietf-oauth-sd-jwt-vc, IETF(I-D.draft-ietf-oauth-sd-jwt-vc-10)]]] Terbu, O., Fett, D., and B. Campbell, "SD-JWT-based Verifiable Credentials (SD-JWT VC)", July 2025, <https://datatracker.ietf.org/doc/html/draft-ietf-oauth-sd-jwt-vc-10>.
...
++++
<bibitem id="XML" type="standard">
  <title format="text/plain">Extensible Markup Language (XML) 1.0 (Fifth Edition)</title>
  <uri type="src">https://www.w3.org/TR/2008/REC-xml-20081126/</uri>
  <docidentifier type="W3C">REC-xml-20081126</docidentifier>
  <date type="published">
    <on>2008-11</on>
  </date>
  <contributor>
...
<bibitem id="SemVer" type="standard">
  <title format="text/plain">Semantic Versioning 2.0.0</title>
  <uri type="src">https://semver.org/spec/v2.0.0.html</uri>
  <docidentifier type="Misc">SemVer 2.0.0</docidentifier>
</bibitem>
<bibitem id="REST" type="book">
  <title format="text/plain">Architectural Styles and the Design of Network-based Software Architectures</title>
  <uri type="src">http://roy.gbiv.com/pubs/dissertation/top.htm</uri>
  <docidentifier type="Doctoral Dissertation">University of California, Irvine</docidentifier>
  <date type="published">
    <on>2000-09</on>
  </date>
  <contributor>
...
<bibitem id="OpenAPI" type="standard">
  <title format="text/plain">OpenAPI Specification</title>
  <uri type="src">https://swagger.io/specification/</uri>
  <docidentifier type="Misc">OpenAPI</docidentifier>
</bibitem>
<bibitem id="W3C-VC" type="standard">
  <title format="text/plain">Verifiable Credentials Data Model v2.0</title>
  <uri type="src">https://www.w3.org/TR/vc-data-model-2.0/</uri>
  <docidentifier type="W3C">vc-data-model-2.0</docidentifier>
  <contributor>
    <role type="editor"/>
    <person>
      <name>
