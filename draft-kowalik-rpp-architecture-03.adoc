...
[[http-layer-detail-status-codes]]
...
* Clarified the relationship and mapping between HTTP status codes and RPP-specific status codes in <<http-layer-detail-status-codes>>.
