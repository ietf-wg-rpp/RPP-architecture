...
== Requirements
This document is based on the requirements defined by RPP WG in state from 5 December 2025 <<RPPReq>>.
...
* **Representation preferences:** Possibility to a client to indicate whether a full representation of an object or only a limited representations is preferred as a response
