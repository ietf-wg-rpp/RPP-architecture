...
* [[[RPPReq, IETF(I-D.draft-ietf-rpp-requirements-01)]]] Wullink, M. and P. Kowalik, "RESTful Provisioning Protocol (RPP) - Requirements", June 2025, <https://datatracker.ietf.org/doc/html/draft-ietf-rpp-requirements-01>.
