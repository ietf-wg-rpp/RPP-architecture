...
RPP Core specifications define only data elements that are strictly necessary for the technical provisioning and maintenance of objects as required at the protocol level. All other data elements are optional at the protocol level.
