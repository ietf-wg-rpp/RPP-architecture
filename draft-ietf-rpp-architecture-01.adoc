...
Data definition of those shall take into account data minimisation principles and enable both clients and servers to limit the dataset to only the necessary data elements required for the intended operation.
