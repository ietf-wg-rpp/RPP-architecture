...
*  Definition of container elements, which are logical groupings that can encapsulate zero or more data elements or other containers ( e.g. map or list).
...
* Added text about collection representation. (Issue #85)
