...
* **Authenticaton Extension:** Functionality for updating client credentials, to support situations where management of authentication credentials is not delegated to a separate identity provider.
...
* Added "Authenticaton Extension" to section "Extension mechanisms"
