...
*  Advertising policies related to data privacy.
...
==== Data privacy
RPP request and response representations may contain personal data or other sensitive information subject to local privacy laws and regulations.
Data definition of those shall take into account data minimisation principles and enable both clients and servers to limit the dataset to only the necessary data elements required for the intended operation. A mean to achieve this goal is to define as small as possible dataset of required information and define all other information as optional on the protocol level. Servers would be able to turn some of the information required by their policy and profile definition.
...
* Added data privacy to "Service discovery mechanisms" and new "Data privacy" section.
