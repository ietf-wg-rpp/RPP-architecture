...
RPP will support mechanisms for revoking or deprecating credentials, tokens, or permissions when they are no longer needed or if they become compromised. 
...
* Added Section <<credential-revocation>> for credential and token revocation mechanisms (Issue #79).
