...
Before any extension is accepted by IANA, a review by an RPP expert must be performed, this review includes a check to determine if the extension does not violate any of the RPP security considerations.
The complete review criteria will be included in the "IANA Considerations" section of any document describing a RPP extension mechanisms, according to the BCP descibed in <<RFC8126>>.
...
* Added IANA expert review to "Extension mechanisms" section.
