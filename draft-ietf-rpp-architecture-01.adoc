...
All RPP specifications shall support the operational practices desribed in <<RFC9154>>, such as not allowing long-term storage of EPP style auth-codes used for object transfer operations.   
...
* Added reference to RFC9154 in the "Security" section. (Issue #89)
