...
* **Status codes:** New RPP status codes can be defined and registered including their mapping to HTTP response status codes.
* **HTTP Headers:** New HTTP headers can be defined and used when mapping RPP data structures or control signals to requests and responses. 
