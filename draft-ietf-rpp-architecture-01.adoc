...
The management of client credentials is not considered to be a part of the core protocol, for this a extension can be created using the extension points described in <<extension-mechanisms>>.
...
* Added text about updating credentials using a extension to "Authentication and Authorisation" section.
