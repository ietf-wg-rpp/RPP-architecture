...
*  Enabling transparent handling of privacy requirements by advertising policies related to data privacy, including data minimisation and purpose limitation rules.
...
The RPP core design supports data minimisation by default, including only the necessary data elements required for the intended operation.
...
* Added data privacy elements to "Service discovery mechanisms" and "Data privacy" sections.
