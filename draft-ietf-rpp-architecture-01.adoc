...
For HTTP Basic Authentication revocation must be fulfilled by off-band operational practice, or using using Authenticaton Extension to rotate the credential.
//TODO: after merging https://github.com/ietf-wg-rpp/RPP-architecture/pull/110 link Authenticaton Extension properly / review text
