...
+
The conclusion is that RPP should not overload HTTP HEAD with own semantics, and support HEAD as it is defined in HTTP. This includes an empty message body for RPP responses for requests using the HEAD method.
...
* Added "Optionality" section to explicitly allow empty HTTP message body in a response.
