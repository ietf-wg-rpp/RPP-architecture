...
RPP may optionally support the creation and verification of digital signatures to provide an additional layer of protection against message tampering. This mechanism can be useful in scenarios where TLS is not (correctly) enabled at some point in the chain of HTTP intermediaries.
